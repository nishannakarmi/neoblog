...
urlpatterns = [
    ...
    path('dashboard/blog/update/<int:pk>/', views.BlogPublishView.as_view(), name="blog_publish"),
    path('dashboard/unpublished/', views.UnpublishBlogListView.as_view(), name="unpublish_blogs"),
    # path('blogs/', views.BlogListView.as_view(), name='blogs'),
